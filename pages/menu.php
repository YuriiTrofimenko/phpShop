...
<ul class="nav nav-pills">
    <li role="presentation" class="nav-item"><a class="nav-link <?php echo ($page == 1) ? 'active' : '' ?>" href="/index.php?page=1">Catalog</a></li>
    <li role="presentation" class="nav-item"><a class="nav-link <?php echo ($page == 2) ? 'active' : '' ?>" href="/index.php?page=2">Cart</a></li>
